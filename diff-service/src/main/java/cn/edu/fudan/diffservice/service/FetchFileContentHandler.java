...
public class FetchFileContentHandler {
    ...
    public String handle(String fileparam) {
        ...
        try {
            ...
            // mMap keys: author,file_name,parent_commit_hash,project_name,project_owner_name,commit_hash
            ...
            String metaStr = FileUtil.read(outputDir + "/" + projectOwnerName + "/" + project_name + "/" + commit_hash + "/meta.json");
            System.out.println("metaStrpath: "+outputDir + "/" + projectOwnerName + "/" + project_name + "/" + commit_hash + "/meta.json");
            ...
            if ("modified".equals(action)) {
                ...
                currFileContent = FileUtil.read(outputDir + "/" + projectOwnerName + "/" + project_name + "/" + commit_hash + "/" + curr_file_path);
                prevFileContent = FileUtil.read(outputDir + "/" + projectOwnerName + "/" + project_name + "/" + commit_hash + "/" + prev_file_path);
