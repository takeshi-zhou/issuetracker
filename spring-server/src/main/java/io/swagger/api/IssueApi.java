...
public interface IssueApi {
    ...
    @RequestMapping(value = "/issue",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<IssuesMsg> getIssues(@NotNull @ApiParam(value = "a project id", required = true) @Valid @RequestParam(value = "project-id", required = true) String projectId,@NotNull @ApiParam(value = " ", required = true) @Valid @RequestParam(value = "page", required = true) String page,@NotNull @ApiParam(value = " ", required = true) @Valid @RequestParam(value = "size", required = true) String size,@NotNull @ApiParam(value = "category", required = true) @Valid @RequestParam(value = "category", required = true) String category);
