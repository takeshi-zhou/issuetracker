...
public interface InnerApi {
    ...
    @RequestMapping(value = "/inner/tags",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<ResponseBean> addMultiTaggedItem(@ApiParam(value = " " ,required=true )  @Valid @RequestBody List<RequestBody2> requestBody);
    ...
    @RequestMapping(value = "/inner/project/{projectId}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Project> getProject(@ApiParam(value = "project that user want to get",required=true) @PathVariable("projectId") String projectId);


    @ApiOperation(value = "get  projectId List", nickname = "getProjectIds", notes = "get  projectId List by account id", response = String.class, responseContainer = "List", tags={ "project-service", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = String.class, responseContainer = "List"),
        @ApiResponse(code = 401, message = "Invalid ID supplied") })
    @RequestMapping(value = "/inner/project/project-id",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<String>> getProjectIds(@ApiParam(value = "account_id that user want to get") @Valid @RequestParam(value = "account_id", required = false) String accountId);
    ...
    @ApiOperation(value = "get Repo Path", nickname = "getRepoPath", notes = "get Repo Path by project_id", response = String.class, tags={ "project-service", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = String.class),
        @ApiResponse(code = 401, message = "Invalid ID supplied") })
    @RequestMapping(value = "/inner/project/repo-path/{project_id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<String> getRepoPath(@ApiParam(value = "project id",required=true) @PathVariable("project_id") String projectId);
